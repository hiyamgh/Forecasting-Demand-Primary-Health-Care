...
output_folder = '../old_output/shallow_tsts/all_columns_minus_weather/train_separated_test_separated/'
        ...
        for mohafaza in mohafazas:
            if service in file and mohafaza in file:
                ...
                lm = LearningModel(df, target_variable='demand',
                                    ...
                                    input_zscore=None, input_minmax=(0, 8) if 'w_{t-5}' in list(df.columns.values) else (0, 7), input_box=None, input_log=None,
                                    cols_drop=None,
