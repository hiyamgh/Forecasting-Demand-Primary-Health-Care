...
# loops over all the column variations
for KEY in datasets:
    print('\n=============================================================================================================')
    print('===================================        %s         =================================================' % KEY)
    print('=============================================================================================================\n')
    ...
    # t is a tuple of the following structure: (threshold - method)

    print('************************************* {} *************************************'.format(t))
    vec = get_bool_method(t[1])
    lm = LearningModel(df=df_train, target_variable='demand', split_ratio=0.2,
                       output_folder='../prob_results_ubr/%s/%s_%s/' % (KEY, t[0], t[1]),
                       ...
                       rel="auto", thr_rel=t[0], Cperc="balance",
