# Title     : DIBSRegress function imported from https://github.com/paobranco/SMOGN-LIDTA17/blob/master/R_Code/DIBSRegress.R
# Objective : include this as a helper function for executing experiments in Python
# Created by: 96171 - hkg02
...
# HIYAM GHANNAM : APPLIED CHANGES TO THE DEFUALT PARAMETERS: method=method, npts=npts, control.pts=control.pts
DIBSRegress <- function(form, dat, method, npts,
                 control.pts, thr.rel = 0.5,
