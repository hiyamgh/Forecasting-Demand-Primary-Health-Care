...
df <- read.csv(file = '../output/feature_selection/ubr/df_smogned.csv')
...
png(filename="../output/feature_selection/ubr/pca.png")
...
png(filename="../output/feature_selection/ubr/pca_pure.png")
ggbiplot(df.pca, obs.scale = 1, var.scale = 1,
